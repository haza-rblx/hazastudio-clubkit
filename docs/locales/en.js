...
window.ClubKitLocale = {
  ...
  strings: {
    ...
    "home.topics.roles.desc": "Role/rank overview plus a step-by-step guide for adding a new role via ClubKitConfig.",
    /* ── Home ── */
    ...
    "home.latest.title": "Latest: 2.5.3",
    "home.latest.body": "Music is global-only — vestigial zone mode removed (single server-wide session).",
    "home.latest.read72": "Read 2.5.3 notes",
    ...
    "updates.version": "Current 2.11.0",
    "updates.v2110.blurb": "Role gradients + name chip, per-role permissions, and anti-cheat guards.",
    "updates.v2110.a1": "<strong>Multi-color role gradients</strong> — up to 5 colors per role: <code>roleColor = { stops = { \"daad18\", \"ffed2a\", \"fdff90\" } }</code>. Chat colors are derived from the first and last stop.",
    "updates.v2110.a2": "<strong>Role name chip</strong> — <code>specialRank = { text = \"THE MINISTER\", gradient = true, chip = true }</code> shows the role as a pill in the chip row above the nametag; that player's <code>#N ROBUX</code> / cash chips are hidden and the rank line shows the role's <code>chatTag</code>.",
    "updates.v2110.a3": "<strong>Per-role permissions</strong> — a role can override its category: <code>privileges = { canGift = false, adminPanel = false }</code>. One visible staff label, different powers per person.",
    "updates.v2110.a4": "<strong>Anti-cheat guards</strong> — rogue audio (the \"random guest played a sound for everyone\" attack), runtime script injection, flying / speed / noclip / teleport, and laser-sized avatars are detected server-side and reported. Movement ships in <strong>log mode</strong> this release: warnings and reports only, nobody is kicked yet — set <code>Config.MovementGuard.ENFORCE = \"kick\"</code> to enforce now.",
    "updates.v2110.a5": "<strong>Custom loading screens</strong> — the kit now publishes boot progress on the player and waits for your own screen (<code>ClubKitExternalLoading</code>); kit music is muted while it is up.",
    "updates.v2110.f1": "<strong>Heavy places failed to boot</strong> — on a large venue at 4–5 FPS the client gave up after 30 s and showed no kit UI. The wait is now 120 s.",
    "updates.v2110.f2": "<strong>Admin Hub \"Set role\"</strong> — the picker was a hardcoded list, so renamed or extra roles could only be given with <code>/setrole</code>. It now reads your own role catalogue.",
    ...
    "updates.whatsLead": "A summary of the changes you will notice in your place. Expand an item for details.",
        "updates.v253.blurb": "Music global-only — vestigial zone mode removed.",
    "updates.v253.r1": "<strong>Zone-based music</strong> — single server-wide session; removed <code>Music.MODE</code>, <code>ZoneTrackerService</code>, <code>MusicZoneChanged</code>, client zone handlers. Buyer <code>ClubKitConfig</code> unaffected.",
    "updates.cat.removed": "Removed",
        "updates.v252.blurb": "Gravity, license/donations, couples, MusicCatalog, Discord invite, Music Library first-open, mobile Admin Hub.",
    "updates.v252.f1": "<strong>Gravity</strong> — dial-scaled idle-down drop + soft landing (no floor bury).",
    "updates.v252.f2": "<strong>License</strong> — verify timeout no longer disables cash donation polling (fail-open).",
    "updates.v252.f3": "<strong>Couples</strong> — chat tag clears on breakup; partner title shows on accept (<code>Taken</code>).",
    "updates.v252.f4": "<strong>Music Library</strong> — first open no longer sticks on Studio placeholders (<code>Playlist Name</code> / <code>05:26</code>).",
    "updates.v252.c1": "<strong>MusicCatalog</strong> — prefer <code>playlists = { { name, tracks = {...} } }</code> (flat list still works).",
    "updates.v252.c2": "<strong>Top Menu Discord</strong> — set <code>Branding.DiscordInvite</code>; empty hides the chip.",
    "updates.v252.c3": "<strong>Mobile</strong> — Admin Hub / JoinCommun phone UIScale.",
