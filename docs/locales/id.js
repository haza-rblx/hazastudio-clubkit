...
window.ClubKitLocale = {
  ...
  strings: {
    ...
    "home.topics.roles.desc": "Overview role/rank + langkah step-by-step nambah role baru lewat ClubKitConfig.",
    /* ── Home ── */
    ...
    "home.latest.title": "Terbaru: 2.5.3",
    "home.latest.body": "Music global-only — zone mode dihapus (satu session server-wide).",
    "home.latest.read72": "Baca catatan 2.5.3",
    ...
    "updates.version": "Saat ini 2.11.0",
    "updates.v2110.blurb": "Gradasi role + chip nama, izin per-role, dan penjaga anti-cheat.",
    "updates.v2110.a1": "<strong>Gradasi role multi-warna</strong> — sampai 5 warna per role: <code>roleColor = { stops = { \"daad18\", \"ffed2a\", \"fdff90\" } }</code>. Warna chat diambil otomatis dari stop pertama & terakhir.",
    "updates.v2110.a2": "<strong>Chip nama role</strong> — <code>specialRank = { text = \"THE MINISTER\", gradient = true, chip = true }</code> menampilkan role sebagai pil di baris chip atas nametag; chip <code>#N ROBUX</code> / cash pemain itu disembunyikan dan baris rank menampilkan <code>chatTag</code> role-nya.",
    "updates.v2110.a3": "<strong>Izin per-role</strong> — satu role bisa menimpa kategorinya: <code>privileges = { canGift = false, adminPanel = false }</code>. Satu label staff yang terlihat, tapi kuasanya beda-beda.",
    "updates.v2110.a4": "<strong>Penjaga anti-cheat</strong> — audio liar (kasus \"tamu random muter suara ke semua orang\"), script injection saat runtime, terbang / speed / noclip / teleport, dan avatar seukuran laser dideteksi di server dan dilaporkan. Rilis ini gerak jalan di <strong>mode log</strong>: hanya peringatan + laporan, belum ada yang di-kick — set <code>Config.MovementGuard.ENFORCE = \"kick\"</code> kalau mau langsung tegas.",
    "updates.v2110.a5": "<strong>Loading screen custom</strong> — kit sekarang menyiarkan progres boot ke pemain dan menunggu layar buatanmu (<code>ClubKitExternalLoading</code>); musik kit di-mute selama layar itu tampil.",
    "updates.v2110.f1": "<strong>Place berat gagal boot</strong> — di venue besar dengan 4–5 FPS client menyerah setelah 30 detik dan UI kit tidak muncul sama sekali. Sekarang tunggu sampai 120 detik.",
    "updates.v2110.f2": "<strong>Admin Hub \"Set role\"</strong> — pilihannya dulu daftar hardcode, jadi role yang diganti nama atau ditambah hanya bisa lewat <code>/setrole</code>. Sekarang membaca katalog role milikmu sendiri.",
    ...
    "updates.whatsLead": "Ringkasan perubahan yang terasa di place kamu. Buka item untuk detail.",
        "updates.v253.blurb": "Music global-only — zone mode vestigial dihapus.",
    "updates.v253.r1": "<strong>Music berbasis zone</strong> — satu session server-wide; hapus <code>Music.MODE</code>, <code>ZoneTrackerService</code>, <code>MusicZoneChanged</code>, handler zone di client. Buyer <code>ClubKitConfig</code> tidak terpengaruh.",
    "updates.cat.removed": "Removed",
        "updates.v252.blurb": "Gravity, license/donasi, couples, MusicCatalog, Discord invite, Music Library first-open, mobile Admin Hub.",
    "updates.v252.f1": "<strong>Gravity</strong> — drop idle-down sesuai dial + soft landing (tidak menembus lantai).",
    "updates.v252.f2": "<strong>License</strong> — timeout verify tidak lagi mematikan cash donation polling (fail-open).",
    "updates.v252.f3": "<strong>Couple</strong> — chat tag bersih saat breakup; partner title muncul saat accept (<code>Taken</code>).",
    "updates.v252.f4": "<strong>Music Library</strong> — buka pertama tidak lagi stuck di placeholder Studio (<code>Playlist Name</code> / <code>05:26</code>).",
    "updates.v252.c1": "<strong>MusicCatalog</strong> — prefer <code>playlists = { { name, tracks = {...} } }</code> (flat list tetap didukung).",
    "updates.v252.c2": "<strong>Top Menu Discord</strong> — set <code>Branding.DiscordInvite</code>; kosong = sembunyikan chip.",
    "updates.v252.c3": "<strong>Mobile</strong> — Admin Hub / JoinCommun UIScale phone lebih kecil.",
