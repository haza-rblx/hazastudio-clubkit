...
window.ClubKitLocale = {
  ...
  strings: {
    ...
    "home.latest.title": "Lo último: 2.5.3",
    "home.latest.body": "Music solo global — modo zona eliminado (una sesión en todo el servidor).",
    "home.latest.read72": "Leer notas 2.5.3",
    "home.latest.upgrade72": "Upgrade 2.5.3",
    ...
    "home.footer.brand": "Hazastudio Clubkit · docs · engine 2.5.3",
    ...
    "updates.version": "Actual 2.11.0",
    "updates.v2110.blurb": "Degradados de rol + chip de nombre, permisos por rol y guardias anti-trampas.",
    "updates.v2110.a1": "<strong>Degradados de rol multicolor</strong> — hasta 5 colores por rol: <code>roleColor = { stops = { \"daad18\", \"ffed2a\", \"fdff90\" } }</code>. Los colores del chat se derivan del primer y último color.",
    "updates.v2110.a2": "<strong>Chip con el nombre del rol</strong> — <code>specialRank = { text = \"THE MINISTER\", gradient = true, chip = true }</code> muestra el rol como una píldora en la fila de chips sobre el nombre; los chips <code>#N ROBUX</code> / efectivo de ese jugador se ocultan y la línea de rango muestra su <code>chatTag</code>.",
    "updates.v2110.a3": "<strong>Permisos por rol</strong> — un rol puede anular su categoría: <code>privileges = { canGift = false, adminPanel = false }</code>. Una sola etiqueta de staff visible, con poderes distintos.",
    "updates.v2110.a4": "<strong>Guardias anti-trampas</strong> — audio no autorizado (el ataque de \"un invitado puso un sonido para todos\"), inyección de scripts en tiempo de ejecución, volar / velocidad / noclip / teletransporte y avatares tamaño láser se detectan en el servidor y se reportan. El movimiento sale en <strong>modo registro</strong>: solo avisos e informes, aún no se expulsa a nadie — usa <code>Config.MovementGuard.ENFORCE = \"kick\"</code> para aplicarlo ya.",
    "updates.v2110.a5": "<strong>Pantallas de carga propias</strong> — el kit publica el progreso de arranque en el jugador y espera a tu pantalla (<code>ClubKitExternalLoading</code>); la música del kit se silencia mientras esté visible.",
    "updates.v2110.f1": "<strong>Lugares pesados no arrancaban</strong> — en un local grande a 4–5 FPS el cliente se rendía a los 30 s y no mostraba nada del kit. Ahora espera 120 s.",
    "updates.v2110.f2": "<strong>Admin Hub \"Set role\"</strong> — el selector era una lista fija, así que los roles renombrados o nuevos solo podían darse con <code>/setrole</code>. Ahora lee tu propio catálogo de roles.",
    ...
    "updates.whatsLead": "Resumen de los cambios que notarás en tu place. Abre un ítem para ver el detalle.",
        "updates.v253.blurb": "Music solo global — modo zona eliminado.",
    "updates.v253.r1": "<strong>Música por zona</strong> — una sesión en todo el servidor; eliminados <code>Music.MODE</code>, <code>ZoneTrackerService</code>, <code>MusicZoneChanged</code> y handlers de zona en cliente. Buyer <code>ClubKitConfig</code> no cambia.",
    "updates.cat.removed": "Removed",
        "updates.v252.blurb": "Gravity, license/donaciones, couples, MusicCatalog, Discord, Music Library first-open, Admin Hub móvil.",
    "updates.v252.f1": "<strong>Gravity</strong> — caída idle-down según dial + aterrizaje suave.",
    "updates.v252.f2": "<strong>License</strong> — timeout de verify ya no corta el polling de donaciones cash (fail-open).",
    "updates.v252.f3": "<strong>Couples</strong> — el chat tag se limpia al romper; título de partner al aceptar.",
    "updates.v252.f4": "<strong>Music Library</strong> — la primera apertura ya no se queda en placeholders de Studio.",
    "updates.v252.c1": "<strong>MusicCatalog</strong> — preferir <code>playlists = { { name, tracks } }</code> (lista flat sigue OK).",
    "updates.v252.c2": "<strong>Top Menu Discord</strong> — <code>Branding.DiscordInvite</code>; vacío oculta el chip.",
    "updates.v252.c3": "<strong>Mobile</strong> — UIScale phone de Admin Hub / JoinCommun.",
    "updates.v252.a1": "<strong>Roles guide</strong> — <a href=\"roles-guide.html\">docs/roles-guide.html</a>.",
"updates.v75.blurb": "Hotfix: crash de sintaxis en DonationController que bloqueaba el arranque del servidor.",
    ...
    "updates.footer.brand": "Hazastudio Clubkit · Updates · engine 2.5.3",
